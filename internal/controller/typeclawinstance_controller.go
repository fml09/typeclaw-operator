...
// The relay Role grants pods get/delete on its own Pod; the manager must
// hold those verbs itself or the API server's privilege-escalation guard
// rejects Role creation.
